        ...
        <View style={styles.deliveryDetailsContainer}>
          ...
          <View style={styles.rowAndCenter}>
            <TouchableOpacity
              ...
              activeOpacity={0.8}
              onPress={() => remove(id)}>
              <Image source={Images.EDIT} style={styles.deliveryDetailsIcon} />
              {/* <Text style={styles.deliveryDetailsText}>Edit</Text> */}
            </TouchableOpacity>
          </View>
          <View style={styles.rowAndCenter}>
            <TouchableOpacity
              ...
              <Image
                ...
                style={styles.deliveryDetailsIcon}
              />
              {/* <Text style={styles.deliveryDetailsText}>Delete</Text> */}
            </TouchableOpacity>
          </View>
        </View>
      </View>
...
export default RestrauntEditDeleteCard;
